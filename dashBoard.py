...
# aqui os dados filtrados por ano são atualizados em novo dataframe
filtered_df = df[(df.data.dt.year == year_to_filter) & (df.classificacao.isin(label_to_filter))]

# Aqui o placehoder vazio é atualizado com dados do filtered_df
...
#para rodar
#> vá ao terminal e digite > streamlit run dashBoard.py